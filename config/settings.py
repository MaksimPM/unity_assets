...
CELERY_BROKER_URL = 'redis://redis:6379/0' # для работы не из докера 'redis://localhost:6379/0'
CELERY_RESULT_BACKEND = 'redis://redis:6379' # для работы не из докера 'redis://localhost:6379'
